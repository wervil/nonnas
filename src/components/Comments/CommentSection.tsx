...
interface CommentSectionProps {
  ...
  userId?: string;
  /**
   * Back-compat display name. Prefer `nonnaTitle` + `nonnaFullName` going forward.
   */
  nonnaName?: string;
  nonnaTitle?: string;
  nonnaFullName?: string;
  /**
   * Optional explicit display name override.
   * Useful when callers already have a combined label.
   */
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-gray-500 mt-1">Discussion</p>
              </div>
            </div>
            {onClose && (
              <button
