...
export default function DiscussionPanel({
  ...
  const user = useUser();
  const [activeTab, setActiveTab] = useState<"discussion" | "nonnas">(
    initialTab,
  );
  const [viewMode, setViewMode] = useState<"list" | "create" | "thread">(
    "list",
  );
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">{scopeDisplay.label}</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-500 text-sm">Loading grandmothers...</p>
              </div>
            ) : nonnas.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900">
                    {nonnas.length}{" "}
                    {nonnas.length === 1 ? "Grandmother" : "Grandmothers"}
