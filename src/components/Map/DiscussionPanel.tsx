    ...
    return (
        <div className="fixed top-15.75 sm:top-20 right-0 sm:h-[calc(100vh-80px)] h-[calc(100vh-63px)] w-full md:w-125 bg-white/95 backdrop-blur-xl shadow-2xl z-99999 border-l border-gray-100/80 animate-in slide-in-from-right duration-300 flex flex-col">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-linear-to-br from-[#9BC9C3]/20 via-[#7FB5B0]/15 to-[#6BA8A3]/10" />
                <div className="absolute top-0 right-0 w-40 h-40 bg-linear-to-br from-[#9BC9C3]/30 to-[#6BA8A3]/30 rounded-full blur-3xl animate-pulse" />
                <div className="absolute bottom-0 left-0 w-32 h-32 bg-linear-to-tr from-[#7FB5B0]/25 to-[#6BA8A3]/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }} />

                {/* Subtle pattern overlay */}
                <div className="absolute inset-0 opacity-5">
                    <div className="h-full w-full" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgb(155 201 195) 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
                </div>
                            ...
                            <div className="flex items-center gap-4 mb-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-3 mt-2">
                                        <span className={`text-xs font-bold px-3 py-1.5 rounded-full bg-linear-to-r from-[#9BC9C3]/30 to-[#7FB5B0]/20 text-[#4A7C7A] border border-[#9BC9C3]/40 backdrop-blur-sm`}>
                                            {scopeDisplay.label}
                                        </span>
                                        <div className="flex items-center gap-1 text-[#6BA8A3]">
            ...
            <div className="flex border-b border-gray-100/80 bg-white/60 backdrop-blur-sm">
                <button
                    ...
                    className={`flex-1 px-6 py-4 text-sm font-(--font-bell) transition-all duration-300 relative ${activeTab === "discussion"
                        ? "text-[#4A7C7A] bg-linear-to-b from-[#9BC9C3]/30 to-transparent"
                        : "text-gray-600 hover:text-gray-800 hover:bg-gray-50/50"
                        }`}
                >
                    <div className="flex items-center justify-center gap-2.5">
                        <MessageCircle className={`w-4.5 h-4.5 ${activeTab === "discussion" ? "text-[#6BA8A3]" : ""}`} />
                        <span>Community</span>
                        {activeTab === "discussion" && (
                            <div className="w-2 h-2 bg-[#7FB5B0] rounded-full animate-pulse" />
                        )}
                    </div>
                    {activeTab === "discussion" && (
                        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-[#9BC9C3] via-[#7FB5B0] to-[#6BA8A3] shadow-lg shadow-[#9BC9C3]/50" />
                    )}
                </button>
                <button
                ...
                >
                    <div className="flex items-center justify-center gap-2.5">
                        <Users className={`w-4.5 h-4.5 ${activeTab === "nonnas" ? "text-[#6BA8A3]" : ""}`} />
                        <span>Nonnas</span>
                        {nonnas.length > 0 && (
                            <span className="ml-1 px-2 py-0.5 text-xs rounded-full bg-linear-to-r from-[#9BC9C3]/30 to-[#7FB5B0]/20 text-[#4A7C7A] font-bold border border-[#9BC9C3]/40">
                                {nonnas.length}
                            </span>
                        )}
                    </div>
                    ...
                    <div className="p-6 pb-24">
                        {viewMode === "list" && (
                            <>
                                ...
                                <div className="mb-8 p-5 rounded-3xl bg-linear-to-br from-[#9BC9C3]/30 via-[#7FB5B0]/20 to-[#6BA8A3]/15 border border-[#9BC9C3]/40 backdrop-blur-sm">
                                    <div className="flex justify-between items-start gap-4">
                                        <div className="flex-1">
                                            <h3 className="text-xl text-gray-900 flex items-center gap-3 font-(--font-bell)">
                                                <div className="w-8 h-8 rounded-xl bg-linear-to-br from-[#9BC9C3] to-[#6BA8A3] flex items-center justify-center shadow-lg shadow-[#9BC9C3]/30">
                                            ...
                                            <div className="flex items-center gap-4 mt-3">
                                                <div className="flex items-center gap-1.5 text-[#6BA8A3]">
                                    ...
                                    {user ? (
                                        <div className="mt-4">
                                            <Button
                                                ...
                                                className="w-full bg-linear-to-r from-[#9BC9C3] via-[#7FB5B0] to-[#6BA8A3] hover:from-[#7FB5B0] hover:via-[#6BA8A3] hover:to-[#5A968F] text-white border-0 shadow-lg shadow-[#9BC9C3]/25 hover:shadow-[#9BC9C3]/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 font-bold"
                                            >
                                        ...
                                        <div className="mt-4">
                                            <Button
                                                ...
                                                className="w-full bg-white/80 backdrop-blur-sm text-[#4A7C7A] border border-[#9BC9C3]/50 hover:bg-[#9BC9C3]/20 font-bold"
                                            >
                                                <div className="flex items-center justify-center gap-2">
                        ...
                        {viewMode === "create" && (
                            <div>
                                <button
                                    ...
                                    className="flex items-center gap-2 text-gray-500 hover:text-[#6BA8A3] mb-6 transition-colors group font-(--font-bell)"
                                >
                                ...
                                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-7 border border-gray-200/60 shadow-lg">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-[#9BC9C3] to-[#6BA8A3] flex items-center justify-center shadow-lg shadow-[#9BC9C3]/30">
                    ...
                    <div className="p-6">
                        {nonnas.length === 0 ? (
                            <div className="text-center py-20">
                                <div className="w-24 h-24 mx-auto mb-8 rounded-3xl bg-linear-to-br from-[#9BC9C3]/30 via-[#7FB5B0]/20 to-[#6BA8A3]/15 flex items-center justify-center border border-[#9BC9C3]/40">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-6 rounded-3xl bg-linear-to-br from-[#9BC9C3]/30 via-[#7FB5B0]/20 to-[#6BA8A3]/15 border border-[#9BC9C3]/40 backdrop-blur-sm">
                                    <div className="flex items-center gap-4">
                                        <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-[#9BC9C3] via-[#7FB5B0] to-[#6BA8A3] flex items-center justify-center shadow-lg shadow-[#9BC9C3]/30 border border-[#9BC9C3]/20">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center gap-2 mt-2">
                                                ...
                                                <span className="text-sm text-[#6BA8A3] font-medium">Sharing traditions</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {nonnas.map((nonna, index) => (
                                    <div
                                        key={nonna.id}
                                        className="group relative bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-200/60 overflow-hidden hover:border-[#7FB5B0]/60 hover:shadow-2xl hover:shadow-[#9BC9C3]/15 transition-all duration-500 hover:scale-[1.02]"
                                        style={{ animationDelay: `${index * 100}ms` }}
                                    >
                                        <div className="flex">
                                            {/* Enhanced Photo */}
                                            <div className="relative shrink-0 w-32 h-32 bg-linear-to-br from-[#4A7C7A]/40 to-[#3A5C5A]/40 flex items-center justify-center overflow-hidden">
                                            ...
                                            <div className="flex-1 p-5 min-w-0">
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="flex-1 min-w-0">
                                                        <h3 className="font-(--font-bell) text-xl text-gray-900 truncate group-hover:text-[#6BA8A3] transition-colors">
                                                            {nonna.name}
                                                        </h3>
                                                        {nonna.recipeTitle && (
                                                            <p className="text-sm font-(--font-bell) mt-2 text-[#6BA8A3]/90 truncate">
                                                                🍝 {nonna.recipeTitle}
                                                            </p>
                                                        )}
                                                    </div>
                                        ...
                                        <div className="absolute bottom-4 right-4">
                                            <button
                                                ...
                                                className="px-5 py-2.5 text-sm text-white rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-linear-to-r from-[#9BC9C3] via-[#7FB5B0] to-[#6BA8A3] hover:from-[#7FB5B0] hover:via-[#6BA8A3] hover:to-[#5A968F] shadow-lg shadow-[#9BC9C3]/30 hover:shadow-[#9BC9C3]/50 hover:scale-105 active:scale-95 font-(--font-bell)"
                                            >
            ...
            <style jsx global>{`
                ...
                .custom-scrollbar::-webkit-scrollbar-track {
                    background: linear-gradient(to bottom, transparent, rgba(155, 201, 195, 0.05), transparent);
                    border-radius: 4px;
                }
                .custom-scrollbar::-webkit-scrollbar-thumb {
                    background: linear-gradient(to bottom, rgba(155, 201, 195, 0.4), rgba(107, 168, 163, 0.4));
                    border-radius: 4px;
                    border: 1px solid rgba(255, 255, 255, 0.2);
                }
                .custom-scrollbar::-webkit-scrollbar-thumb:hover {
                    background: linear-gradient(to bottom, rgba(155, 201, 195, 0.6), rgba(107, 168, 163, 0.6));
                }
