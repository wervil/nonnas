...
export const Book = forwardRef<BookHandle, Props>(
  ({ recipes, tableOfContents, initialRecipeId }, ref) => {
    ...
    }, [isSidebarOpen, recipes.length, isClient]);
              ...
              {currentPage === 0 && (
                <div className="flex flex-col justify-center ml-32 pr-8 w-[55%] max-w-[500px]">
                  ...
                  <p className="text-gray-900 text-2xl leading-10">
                    This is a living cookbook and historical archive where
                    grandmother from every corner of the globe share their
                    culinary wisdom, cultural traditions, and timeless recipes.
                    Add your own Noona to our growing tapestry of stories,
              ...
              >
                {contentHeight > 0 && (
                  <HTMLFlipBook
                    ...
                    width={isMobile ? 250 : contentHeight * 0.8}
                    height={isMobile ? 450 : contentHeight * 0.85}
                    minHeight={isMobile ? 450 : contentHeight * 0.75}
                    ...
                    maxHeight={isMobile ? 450 : contentHeight * 0.8}
                    flippingTime={1000}
