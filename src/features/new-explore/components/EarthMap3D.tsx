...
const StreetViewLayer = dynamic(() => import("./StreetViewLayer"), {
  ssr: false,
});
const ExploreDiscussionPanel = dynamic(
  () => import("./ExploreDiscussionPanel"),
  { ssr: false },
);
const ExploreCommentsDrawer = dynamic(
  () => import("./ExploreCommentsDrawer"),
  { ssr: false },
);
    ...
    async function init() {
      ...
      (async () => {
        try {
          ...
          console.warn(
            "[Earth3D] Boundary cache preload failed (will lazy-load):",
            e,
          );
        }
      })();
      ...
      listeners.push(() =>
        map3d.removeEventListener("pointermove", handleDomPointerMove),
      );
      listeners.push(() =>
        map3d.removeEventListener("mousemove", handleDomPointerMove),
      );
